...
class SampleFrame extends JFrame implements EWrapper {
    ...
    public void tickOptionComputation( int tickerId, int field, double impliedVol, double delta, double modelPrice, double pvDividend) {
    	...
    	String msg = "tickOptCom " + EWrapperMsgGenerator.tickOptionComputation( tickerId, field, impliedVol, delta, modelPrice, pvDividend);
        m_tickers.add( msg );
    }
    ...
    public void tickSnapshotEnd(int tickerId) {
    	String msg = "tickSnap " +EWrapperMsgGenerator.tickSnapshotEnd(tickerId);
    	m_tickers.add( msg) ;
    }
    ...
    public void tickEFP(int tickerId, int tickType, double basisPoints, String formattedBasisPoints,
        ...
        // received EFP tick
    	String msg = "tickEFP " + EWrapperMsgGenerator.tickEFP(tickerId, tickType, basisPoints, formattedBasisPoints,
    ...
    public void scannerData(int reqId, int rank, ContractDetails contractDetails,
    	...
    	String msg = "scanner " + EWrapperMsgGenerator.scannerData(reqId, rank, contractDetails, distance,
    			benchmark, projection, legsStr);
        m_tickers.add(msg);
    }
    
    public void scannerDataEnd(int reqId) {
    	String msg = "scannerEnd " + EWrapperMsgGenerator.scannerDataEnd(reqId);
    	m_tickers.add(msg);
    }
    ...
    public void historicalData(int reqId, String date, double open, double high, double low,
        ...
        String msg = "historical " + EWrapperMsgGenerator.historicalData(reqId, date, open, high, low, close, volume, count, WAP, hasGaps);
    	m_tickers.add( msg );
    }
	public void realtimeBar(int reqId, long time, double open, double high, double low, double close, long volume, double wap, int count) {
		String msg = "realTime " + EWrapperMsgGenerator.realtimeBar(reqId, time, open, high, low, close, volume, wap, count);
        m_tickers.add( msg );
	}
	...
	public void fundamentalData(int reqId, String data) {
		String msg = "funda " + EWrapperMsgGenerator.fundamentalData(reqId, data);
		m_tickers.add(msg);
	}
